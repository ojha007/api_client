...
ColReorder.prototype = {
	...
	"_fnMouseMove": function ( e )
	{
		...
		if ( this.dom.drag === null )
		{
			 ...
			 * point - this allows the users to make small mouse movements when sorting and not have a
	...
	/**
	 * Copy the TH element that is being drags so the users has the idea that they are actually
...
ColReorder.defaults = {
	...
	/**
	 * Redraw the table's column ordering as the end users draws the column
